...
const char* ourObjectPath = "./handcream.obj";
...
void myDisplay()
{
	...
	// Draw Teapot
	objectXform = glm::rotate(objectXform, glm::radians(255.0f), glm::vec3(1.0f, 0.0f, 0.0f));
	objectXform = glm::scale(objectXform, glm::vec3(0.05f, 0.05f, 0.05f));
